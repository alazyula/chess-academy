  ...
  <form onSubmit={handleSubmit} className="mt-4">
    <div className='text-black dark:text-white'>
      ...
      <input
        ...
        className="mt-1 px-2 block w-full lg:w-1/2 mx-2 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
        required
      />
    </div>
    <div className="mt-4">
      ...
      <textarea
        ...
        rows={4}
        className="mt-1 block mx-2s w-full px-2 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
        required
      />
    </div>
    <button
